...
@loader.tds
class FarmIrisModW(loader.Module):
    """Для автоматического фарминга коинов в ирисботе"""

    strings = {
        "name": "farmirisw",
        "farmonw": "<i>✅Отложенка создана, автофарминг запущен, всё начнётся через 20 секунд...</i>",
        "farmon_already": "<i>Уже запущено</i>",
        "farmoffw": "<i>❌Автофарминг остановлен.\n☢️Надюпано:</i> <b>%coins% i¢</b>",
        "farmw": "<i>☢️Надюпано:</i> <b>%coins% i¢</b>",
    }
    ...
    async def farmonwcmd(self, message):
    ...
    async def farmoffwcmd(self, message):
    ...
    async def farmwcmd(self, message):
